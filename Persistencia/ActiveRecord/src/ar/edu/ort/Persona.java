...
public class Persona implements Persistible {
	...
	private final static String consultaBusquedaFiltro =
			"SELECT idPersona, apellido, nombre, cantidadHijos" +
					" FROM persona" +
	...
	public void buscar(String filtro) {
		...
		ResultSet rs = null;
		try {
			query = DB.prepararConsulta(consultaBusquedaFiltro);
			query.setLong(1, filtro);
			query.setLong(2, filtro);
			rs = query.executeQuery();
			rs.next();
			cargar(rs);
		} catch (SQLException e) {
	...
	public Long obtenerProximoId() {
		return new Long(12);//Deber�a obtenerlo de la base de datos
	}
	...
	/**
	 * M�s m�todos de la l�gica del negocio...
	**/
}